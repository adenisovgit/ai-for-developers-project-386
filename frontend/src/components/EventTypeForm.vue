...
<template>
  <form class="space-y-5" @submit.prevent="onSubmit">
    <div>
      ...
      <Input v-model="title" placeholder="Например, Знакомство" />
